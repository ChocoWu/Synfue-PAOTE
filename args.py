...
def _add_common_args(arg_parser):
    ...
    arg_parser.add_argument('--model_type', type=str, default="SynFue", help="Type of model")
    ...
    # LaGCN
    arg_parser.add_argument('--bert_dim', type=int, default=768)
    arg_parser.add_argument('--dep_dim', type=int, default=100)
    arg_parser.add_argument('--bert_dropout', type=float, default=0.5)
    arg_parser.add_argument('--output_dropout', type=float, default=0.5)
    arg_parser.add_argument('--dep_num', type=int, default=42)  # 40 + 1(None) + 1(self-loop)
    arg_parser.add_argument('--num_layer', type=int, default=3)

    # Misc
    arg_parser.add_argument('--seed', type=int, default=58986, help="Seed")
    ...
    arg_parser.add_argument('--beta', type=float, default=0.3, help='weight for triaffine')
    arg_parser.add_argument('--alpha', type=float, default=0.3, help='weight for biaffine')
    arg_parser.add_argument('--sigma', type=float, default=0.3, help='weight for syntactic-aware score')

    # pos
    # arg_parser.add_argument('--use_pos', type=bool, default=True)
    arg_parser.add_argument('--pos_num', type=int, default=45)
    arg_parser.add_argument('--pos_dim', type=int, default=100)
    arg_parser.add_argument('--w_size', type=int, default=1, help='the window size of local attention')
...
def train_argparser():
    ...
    arg_parser.add_argument('--neg_term_count', type=int, default=100,
