...
from SynFue import input_reader
from SynFue.trainer import SynFueTrainer


def __train(run_args):
    trainer = SynFueTrainer(run_args)
...
if __name__ == '__main__':
    ...
    if args.train_mode == 'train':
        ...
        raise Exception("Mode not in ['train', 'eval'], e.g. 'python SynFue.py train ...'")
