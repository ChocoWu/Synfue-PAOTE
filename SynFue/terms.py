...
class Document:
    def __init__(self, doc_id: int, tokens: List[Token], terms: List[Term], relations: List[Relation],
...
class Dataset(TorchDataset):
    ...
    def create_document(self, tokens, term_mentions, relations, doc_encoding, dep_label, dep_label_indices, dep,
                        pos, pos_indices) -> Document:
        document = Document(self._doc_id, tokens, term_mentions, relations, doc_encoding, dep_label,
