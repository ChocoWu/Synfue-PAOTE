...
from SynFue.terms import Dataset, TermType, RelationType, Term, Relation, Document
...
class JsonInputReader(BaseInputReader):
    ...
    def _parse_document(self, doc, dataset) -> Document:
        ...
        # create document
        document = dataset.create_document(doc_tokens, terms, relations, doc_encoding, jdep_label,
